...
def get_bg_fg_color(
    ...
    fg_color, bg_color = palette[0].rgb, palette[-1].rgb
    
    return fg_color, bg_color

    
if __name__ == "__main__":
    _input = 'title_vertical.png'
    fg_color, bg_color = get_bg_fg_color(image= _input)
    print(f'fg color: {fg_color}')
